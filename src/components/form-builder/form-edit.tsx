...
import { FormElementsDropdown } from "@/components/form-builder/form-elements-dropdown";
		...
		<div className="w-full group">
			<div className="flex items-center justify-between px-2">
				...
				<div className="flex items-center justify-end lg:opacity-0 opacity-100 group-hover:opacity-100 duration-100">
					...
					{/* {!isNested && (
						<FormElementsDropdown fieldIndex={fieldIndex} />
					)} */}
				</div>
			</div>
...
export function FormEdit() {
	...
	if ((formElements as FormElementOrList[]).length === 0) {
